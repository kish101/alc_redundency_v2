...
void setup()
{
  ...
  //..................................................................... set software serial
  {
    ...
    else
    {
      ...
      if (inital_uart_setup_slave())
      {
        ...
        if (configFile_read())
        {
          Serial.println("redundancy slave received the config file as followes ");
          Serial.println(config_file_str);
          Serial.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>confi.txt credentials in 3 seconds");
          print_arr(6);
          delay(3000);
        }//if
        else
          Serial.println("redundancy slave didnt receive any file");
  ...
  //..................................................................... Config screen setup
  {
    ...
    server.on("/src.f11513b5.css", HTTP_GET, onCSSRequest_src1);
    ...
    server.on("/src.780973c7.js", HTTP_GET, onJSRequest_src1);
  ...
  if ((softUart_select == 0) && (redundancy_flag == 1))
  {
    ...
    //.............................................. set OP/IP
    numberOfShiftRegisters = (exor_state_str.length() / 8);
